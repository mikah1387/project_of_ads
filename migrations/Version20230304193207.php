 ...
 */
final class Version20230304193207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonces_users (annonces_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_F60119834C2885D7 (annonces_id), INDEX IDX_F601198367B3B43D (users_id), PRIMARY KEY(annonces_id, users_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
